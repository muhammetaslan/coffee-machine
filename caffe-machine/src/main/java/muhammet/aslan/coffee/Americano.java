...
public class Americano extends Drink {
    ...
    public void prepare(Map<String, Integer> stockMeterialMap) throws SQLException {
        ...
        fillHotWater(ingredients.get(1).getName(), (stockMeterialMap.get(ingredients.get(1).getName()) - ingredients.get(1).getQuantity()));
    }

    @Override
    public void giveOrderInfo() {
        System.out.println("*********************************************************");
        System.out.println("Americano seçtiniz. Bu içeceğimizin içeriği şu şekildedir\n");
        List<Ingredient> ingredients = getRecipe().getIngredients();
