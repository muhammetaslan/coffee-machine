...
public class DoubleEspresso extends Drink {

    private Recipe recipe;

    public DoubleEspresso(Recipe recipe){
        super();
        this.recipe = recipe;
    }
    ...
    public void giveOrderInfo() {
        System.out.println("*************************************************************");
        System.out.println("DoubleEspresso seçtiniz. Bu içeceğimizin içeriği şu şekildedir\n");
        List<Ingredient> ingredients = getRecipe().getIngredients();
